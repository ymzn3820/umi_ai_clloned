...
export function getQuestion(data){
	return get({
		url: global.memberUrl + '/pay/questions_set/?module_id='+ data.module_id +'&question_id=' +data.question_id,
		data: ''
	})
}
...
export function getMission(data){
	return get({
		url: global.loginUrl + '/api/user/commission_history?page_size='+ data.page_size +'&page=' +data.page,
		data: ''
	})
}
